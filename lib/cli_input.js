...
module.exports = {
    ...
    askAppComponents: (components=component_list) => {
        const question = {
            type: 'checkbox',
            name: 'components',
            message: 'Select the common components you want to include in your project (use space to select & enter to continue) :',
            choices: components,
            default: ['all']
        }
        return inquirer.prompt(question);
